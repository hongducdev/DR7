...
desc2.putUnitDouble(cTID("Amnt"), cTID("#Prc"), 22);
desc2.putUnitDouble(cTID("Wdth"), cTID("#Prc"), 18);
desc2.putInteger(cTID("Rds "), 96);
...
desc1.putReference(cTID("null"), ref1);
var desc2 = new ActionDescriptor();
desc2.putString(cTID("Nm  "), "S\u1eeda v\u00f9ng t\u1ed1i");
